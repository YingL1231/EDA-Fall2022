...
epa_pm25_sites_sf <- read_csv('C:/Users/Alina/Desktop/DUKE_22FALL/872/EDA-Fall2022/Data/Raw/EPAair_PM25_NC2018_raw.csv') %>% 
...
#
counties_sf<- st_read('C:/Users/Alina/Desktop/DUKE_22FALL/872/EDA-Fall2022/Data/Spatial/cb_2018_us_county_20m.shp') %>% 
...
huc8_sf<-st_read('C:/Users/Alina/Desktop/DUKE_22FALL/872/EDA-Fall2022/Data/Spatial/NCHUC8.shp')
#Reveal the columns
...
upperNeuse_sf<-st_read('C:/Users/Alina/Desktop/DUKE_22FALL/872/EDA-Fall2022/Data/Spatial/NCHUC8.shp')%>%
  filter(SUBBASIN=='Upper Neuse')

#Create a map

mapview(huc8_sf,col.regions='orange')+
  mapview(upperNeuse_sf,col.regions='purple')
...
```
```{r}
edu_sf <- st_read('https://services1.arcgis.com/Hp6G80Pky0om7QvQ/arcgis/rest/services/Colleges_and_Universities/FeatureServer/0/query?outFields=*&where=1%3D1&f=geojson')
#Reveal the field names
colnames(edu_sf)
...
svi2018_nc_raw <- read.csv(
  ...
  colClasses = c('FIPS' = 'factor')) %>% #can't use stringasfactor, so this change FIPS to factor
...
wind_energy_sf<-read.csv('https://raw.githubusercontent.com/ENV859/EnviroAtlasData/main/Wind_Energy.csv',colClasses = c('HUC_12' = 'factor'))%>%
  mutate(HUC_8=substr(HUC_12,1,8))%>%#create a column with HUC8
  group_by(HUC_8)%>%
  summarize(kWhkm2day=sum(kWhkm2day))

#Join to HUC_8 features
huc8_sf_wind<-huc8_sf%>%left_join(wind_energy_sf,by=c('HUC_8','HUC_8'))
#View the outputs
mapview(huc8_sf_wind,zol='zKhkm2day')

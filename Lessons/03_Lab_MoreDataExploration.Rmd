...
```{r}
vector1<-c(93,93,73,78,85,82,78,75,73,71)
vector2<-c(65,53,48,59,61,54,51,51,52,55)
tocelsius<-function(Fahren,Celsius){
  Celsius=(Fahren-32)*5/9
  return(Celsius)
}
vector3<-tocelsius(vector1)
vector4<-tocelsius(vector2)
vector3
vector4
```
```{r}
...
f<-vector3
g<-vector4
temp<-data.frame(d,e,f,g)
names(temp) <- c("highF","lowF","highC","lowC"); View(temp)
...
matrix1[4, ] #
matrix1[ , 3] #
matrix1[c(12, 14)] #go through by rows and find 12 and 14
matrix1[c(12:14)] #go through by rows and find 12 13 14
matrix1[2:4, 1:3] #
...
# Lists ---- combination of different data
list1 <- list(name = "Maria", mynumbers = vector1, mymatrix = matrix1, age = 5.3);
list1
list1[[2]]#print the second item in the list, in this case "mynumbers"
...
names(dataframe1) <- c("ID","Color","Passed"); View(dataframe1) #name rows and colums 

dataframe1[1:2,] # 
dataframe1[c("ID","Passed")] # 
dataframe1$ID# $ gives the list of colum

...
#What does "na.rm=T" do? Is it necessary?

#Convert longitute and latitude columns into a spatial dataframe
...
# only a dot, wanna know where it is in the world?

#Upgrade to a simple feature geometry column by adding a crs 
sfc_GraingerHall <- st_sfc(sfg_GraingerHall,crs=4326)#add crs system 
